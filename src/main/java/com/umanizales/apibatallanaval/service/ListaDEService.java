...
public class ListaDEService
{
    ...
    public ResponseEntity<Object> adicionarDistribucionBarcoalInicio(DistribucionBarcoDTO distribucion)
    {
        listaBarcos.adicionarNodoAlInicio(distribucion);
        return new ResponseEntity<>(new RespuestaDTO("Exitoso","Barco adicionado al inicio"
                ,null), HttpStatus.OK);
    }

    public ResponseEntity<Object> eliminarDistribucionBarcoalInicio(DistribucionBarcoDTO distribucion)
    {
        listaBarcos.eliminarNodoAlInicio(distribucion);
        return new ResponseEntity<>(new RespuestaDTO("Exitoso","Barco eliminado al inicio"
                ,null), HttpStatus.OK);
    }

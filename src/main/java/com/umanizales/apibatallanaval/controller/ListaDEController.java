...
public class ListaDEController
{
    ...
    @PostMapping
    public @ResponseBody ResponseEntity<Object> adicionarDistribucionBarcoAlInicio (@RequestBody Barco barco)
    {
        DistribucionBarcoDTO distribucion = new DistribucionBarcoDTO(barco);
        return listaDEService.adicionarDistribucionBarcoalInicio(distribucion);
    }

    @PostMapping
    public @ResponseBody ResponseEntity<Object> eliminarDistribucionBarcoAlInicio (@RequestBody Barco barco)
    {
        DistribucionBarcoDTO distribucion = new DistribucionBarcoDTO(barco);
        return listaDEService.eliminarDistribucionBarcoalInicio(distribucion);
    }
